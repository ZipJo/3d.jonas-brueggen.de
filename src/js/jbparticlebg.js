...
let pBg = function(qSelector, parameters) {
    ...
    pBg.functions.initThreeJs = function() {
        ...
        //setup camera
        pBg.threejs.camera = new THREE.PerspectiveCamera(50, pBg.threejs.aspect, 100, 10000);
    ...
    pBg.functions.renderThreeJs = function() {
        ...
        pBg.threejs.cube.rotateY(pBg.threejs.vars.autoRotationSpeed);
        pBg.threejs.cube.rotateX(pBg.threejs.vars.autoRotationSpeed/2);
